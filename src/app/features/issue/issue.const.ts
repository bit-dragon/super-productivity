...
import {BITBUCKET_CONFIG_FORM_SECTION, DEFAULT_BITBUCKET_CFG} from './providers/bitbucket/bitbucket.const';
...
export const BITBUCKET_TYPE: IssueProviderKey = 'BITBUCKET';

// TODO uppercase
export const issueProviderKeys: IssueProviderKey[] = [JIRA_TYPE, GITHUB_TYPE, GITLAB_TYPE, BITBUCKET_TYPE];

export const issueProviderIconMap = {
  [JIRA_TYPE]: 'jira',
  [GITHUB_TYPE]: 'github',
  [GITLAB_TYPE]: 'gitlab',
  [BITBUCKET_TYPE]: 'bitbucket'
};
...
export const DEFAULT_ISSUE_PROVIDER_CFGS = {
  ...
  [BITBUCKET_TYPE]: DEFAULT_BITBUCKET_CFG,
};
...
export const ISSUE_PROVIDER_FORM_CFGS: ConfigFormConfig = [
  ...
  (BITBUCKET_CONFIG_FORM_SECTION as GenericConfigFormSection),
];
